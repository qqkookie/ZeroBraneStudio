...
if [ $BUILD_LUASEC ]; then
  ...
  install_name_tool -change /usr/local/lib/libcrypto.1.1.dylib @rpath/libcrypto.dylib "$INSTALL_DIR/lib/lua/$LUAV/ssl.dylib"
  install_name_tool -change /usr/local/lib/libssl.1.1.dylib @rpath/libssl.dylib "$INSTALL_DIR/lib/lua/$LUAV/ssl.dylib"
